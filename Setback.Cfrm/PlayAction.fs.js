...
import { LeadActionModule_copyTo, LeadActionModule_layout, LeadActionModule_getPlay, LeadActionModule_getActions, LeadAction$reflection } from "./LeadAction.fs.js";
import { FollowActionModule_copyTo, FollowActionModule_layout, FollowActionModule_getPlay, FollowActionModule_getActions, FollowAction$reflection } from "./FollowAction.fs.js";
...
import { SpanLayout_ofLength } from "./SpanLayout.fs.js";
...
export const PlayActionModule_layout = ((!(LeadActionModule_layout.Length === FollowActionModule_layout.Length)) ? (() => {
    debugger;
})() : null, SpanLayout_ofLength(LeadActionModule_layout.Length));

export function PlayActionModule_copyTo(span, _arg1) {
    if (_arg1.tag === 1) {
        const action_1 = _arg1.fields[0];
        FollowActionModule_copyTo(span, action_1);
    }
    else {
        const action = _arg1.fields[0];
        LeadActionModule_copyTo(span, action);
    }
}
