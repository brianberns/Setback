...
type Settings =
    {
        ...
        /// Number of deal groups to evaluate model.
        NumEvaluationDealGroups : int
...
module Settings =
    ...
    let settings =
        ...
        writer.add_text(
            ...
            string settings.NumEvaluationDealGroups, 0)
