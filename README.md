...
2. Copy `Baseline.strategy` into the `TrainBootstrap` project and run it to bootstrap a strategy profile (`Bootstrap.strategy`) that is optimized for score-aware bidding (e.g. by bidding more aggressively if the opposing team is close to winning the game). This requires less time and RAM. I recommend 20-30 CFR iterations.
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDQyMjY0ODIwXX0=
-->