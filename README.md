...
# Approach
Setback's move tree is not as large as some other card games (e.g. Bridge, Hearts), but it is still too large for vanilla CFR. The approach used here is to create an abstract game that is quite similar to Setback, but whose move tree is small enough for vanilla CFR. This abstraction is much more of an art than a science, relying heavily on personal intuition for what information is most salient when playing Setback.
# Usage
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMzM0NTYxOTUsLTgxMjAzOTI0MF19
-->