...
```
them-need/us-need/high-bid/num-bids/hand
```
...
* `high-bid`: The current high bid (`2`, `3`, or `4`) or `-1` if there is no current high bid.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjE0NjU4ODI3NCw3ODkzOTEzMDUsNzAyNT
