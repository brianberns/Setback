...
# Approach
Setback's move tree is not as large as some other card games (e.g. Bridge, Hearts), but it is still much too large for vanilla CFR. The approach used here is to create an abstract game that is quite similar to Setback, but whose move tree is small enough for vanilla CFR.
# Usage
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNzQ4NTUyNjIsLTgxMjAzOTI0MF19
-->