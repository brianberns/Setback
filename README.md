...
| 12-13 | Legal action #1 | `Tr` (play trump of rank `r`)<br/> `S.` (lead a strong non-trump)<br/>`W.` (lead a weak non-trump)<br/> |`Wx` (pla
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMDAwMzQ2MTYsMTMyMTY1MjIxLDIwNz
U1ODcwOTcsLTgxMjAzOTI0MF19
-->